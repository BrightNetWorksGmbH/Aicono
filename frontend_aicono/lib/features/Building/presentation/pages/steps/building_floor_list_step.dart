          ...
          child: ConstrainedBox(
            ...
            if (_totalFloors > 0)
              ...List.generate(_totalFloors, (index) {
                ...
                final isCompleted = _completedFloors.contains(floorNumber);
                return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text(isCompleted ? 'Bearbeiten' : 'Hinzufügen'),
            ...
            if (_completedFloors.length == _totalFloors && _totalFloors > 0)
              ElevatedButton(
