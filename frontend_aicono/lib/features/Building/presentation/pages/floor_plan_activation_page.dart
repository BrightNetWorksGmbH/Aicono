...
class FloorPlanActivationPage extends StatefulWidget {
  ...
  @override
  State<FloorPlanActivationPage> createState() =>
      _FloorPlanActivationPageState();
}

class _FloorPlanActivationPageState extends State<FloorPlanActivationPage> {
                                    ...
                                    onPanStart: (details) {
                                      ...
                                      if (_drawingMode ==
                                        ...
                                        if (selectedRoom != null) {
                                          final bounds = selectedRoom!.path
                                              .getBounds();
