...
class _FloorPlanPageState extends State<FloorPlanPage> {
  ...
  Path createRectangle(Offset o, {double width = 200, double height = 150}) {
    return Path()
      ..moveTo(o.dx, o.dy)
  ...
  Path createCircle(Offset center, {double radius = 100}) {
                ...
                _structureButton(Icons.circle, "Circular room", () {
                  ...
                  setState(() {
                    rooms.add(
                      Room(
                        id: UniqueKey().toString(),
                        path: createCircle(const Offset(200, 200), radius: 100),
                        fillColor: selectedColor ?? const Color(0xFFF5F5DC),
                        name: 'Room $_roomCounter',
                      ),
                    );
